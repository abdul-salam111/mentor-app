...
class MenteeConnectionsView extends GetView<MenteeConnectionsController> {
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              5.heightBox,
              FutureBuilder(
                  future: controller.getMenteeConnections(),
                  builder:
                      (context, AsyncSnapshot<GetMenteeConnections> snapshot) {
                    if (!snapshot.hasData) 
                    {
                      return ShimmerList();
                    } 
                    ...
                    return Expanded(
                      child: ListView.builder(
                          shrinkWrap: true,
                          itemCount: snapshot.data!.menteeConnections.length,
                            ...
                            return Row(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      snapshot.data!.menteeConnections[index]
                                          .fullName
                                          .toString(),
                                      style: manoropeFontFamily(
                                          fontSize: 16.sp,
