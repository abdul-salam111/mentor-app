...
String getMenteeConnectionsToJson(GetMenteeConnections data) => json.encode(data.toJson());

class GetMenteeConnections {
    ...
    factory GetMenteeConnections.fromJson(Map<String, dynamic> json) => GetMenteeConnections(
